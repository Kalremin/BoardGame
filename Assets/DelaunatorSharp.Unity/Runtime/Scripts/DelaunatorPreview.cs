...
namespace DelaunatorSharp.Unity.Extensions
{
    public partial class DelaunatorPreview : MonoBehaviour
    {
        ...
        [SerializeField] Transform topRight, lowerLeft;
        [SerializeField] Transform topLeft, lowerRight;
        ...
        void Update()
        {
            ...
            if (Input.GetKeyDown(KeyCode.Return))
            {
                ...
                //var sampler = UniformPoissonDiskSampler.SampleRectangle(lowerLeft.position, topRight.position, generationMinDistance);
        ...
        private void CreateLine(Transform container, string name, Vector3[] points, Color color, float width, int order = 1)
        {
            ...
            /*
             라인 프리펩이 포인트 프리펩에 연결되었다는 것을 알리는 변수 필요
             */
